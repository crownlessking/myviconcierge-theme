        ...
        <?php if (has_custom_logo()) : ?>
          ...
          <div class="w-full lg:flex lg:items-center lg:w-auto hidden" id="navbar-collapse">
            <ul class="lg:flex lg:items-center lg:justify-between text-white lg:space-x-4">
              ...
              <li><a href="#" class="block lg:inline-block mt-4 lg:mt-0 nav-link-bold-shadow">Blog/News</a></li>
              <li><a href="https://crownlessking.com" class="block lg:inline-block mt-4 lg:mt-0 nav-link-bold-shadow">About</a></li>
            </ul>
          </div>
      </div>
    </nav>
